...
ဒီသင်ခန်းစာမှာတော့ အောက်ပါအကြောင်းအရာများကို လေ့လာသွားကြမှာ ဖြစ်ပါတယ်
...
[More About Array](documents/arrays.md)

### TypeScript Specific Type

TypeScript မှာ JavaScript ရဲ့ Data Type တွေကိုလဲ အသုံးပြုနိုင်ကြသလို TypeScript ဘက်ကနေ ပြင်ဆင်ပေးထားတဲ့ Type တွေလဲ ရှိကြပါတယ်
